...
public class Coordinates extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3554443883188088775L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Coordinates\",\"namespace\":\"avro.schemas.v1\",\"fields\":[{\"name\":\"lat\",\"type\":\"float\"},{\"name\":\"lon\",\"type\":\"float\"}]}");
   ...
   */
  public static avro.schemas.v1.Coordinates.Builder newBuilder() {
    return new avro.schemas.v1.Coordinates.Builder();
  }
   ...
   * @return A new Coordinates RecordBuilder
   */
  public static avro.schemas.v1.Coordinates.Builder newBuilder(avro.schemas.v1.Coordinates.Builder other) {
    if (other == null) {
      return new avro.schemas.v1.Coordinates.Builder();
    } else {
      return new avro.schemas.v1.Coordinates.Builder(other);
    }
  }
   ...
   * @return A new Coordinates RecordBuilder
   */
  public static avro.schemas.v1.Coordinates.Builder newBuilder(avro.schemas.v1.Coordinates other) {
    if (other == null) {
      return new avro.schemas.v1.Coordinates.Builder();
    } else {
      return new avro.schemas.v1.Coordinates.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Coordinates>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.schemas.v1.Coordinates.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.schemas.v1.Coordinates other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.lat)) {
        this.lat = data().deepCopy(fields()[0].schema(), other.lat);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schemas.v1.Coordinates.Builder setLat(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schemas.v1.Coordinates.Builder clearLat() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schemas.v1.Coordinates.Builder setLon(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schemas.v1.Coordinates.Builder clearLon() {
